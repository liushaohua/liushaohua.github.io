var state_list = new Array();
	...
	state_list[1017] = '请填写邮箱地址！';
	state_list[1018] = '请填写手机号码！';
	...
	state_list[1058] = '您只能上传12张照片，您可以先删除原有照片后重新上传！';
	state_list[1059] = '收藏失败';
	state_list[1060] = '取消收藏失败';
	state_list[1061] = '用户类型不匹配!';
	state_list[1062] = '您已收藏过!';
	state_list[1063] = '用户不存在!';
	state_list[1064] = '该用户未收藏红人!';
	state_list[1065] = '该用户未收藏机构!';
	state_list[1066] = '该用户未收藏招募!';
	...
	state_list[1222] = '账号身份不匹配，请重新登陆!';
	state_list[1223] = ' 账号身份已过期，请重新登陆!';
	state_list[1225] = ' 密码不正确!';//输错三次
	state_list[1226] = ' 验证码错误!';//login验证码
	...
	state_list[1182] = '请选择邀约的服务!';		
	state_list[1183] = '请不要重复邀约!';		
	state_list[1184] = '添加邀约失败!';		
	state_list[1185] = '添加服务失败!';		
	
	state_list[1190] = '您的邮箱已经通过验证!';
	
	
	state_list[1301] = '标签获取错误';
	state_list[1302] = '标签操作失败';
	state_list[1303] = '标签没有变化或者标签没有填写';
	state_list[1304] = '用户未设置标签';
	state_list[1305] = '转换标签id失败';
	state_list[1306] = '自定义标签更新失败';
	state_list[1307] = '用户标签id删除失败';
	state_list[1308] = '用户单个标签id删除失败';
	state_list[1309] = '用户要删除的单个标签信息查询失败';
	
	state_list[1311] = '系统标签初始化失败';
	state_list[1312] = '机构添加标签失败';
	state_list[1313] = '未选择任何标签';
	state_list[1314] = '获取机构标签id失败';
	state_list[1315] = '获取机构标签失败';
	state_list[1316] = '自定义标签写入失败';
	state_list[1317] = '用户标签删除失败';
	
	state_list[1320] = '私信发送失败！（插入失败）';
	state_list[1321] = '私信发送失败！';
	state_list[1322] = '私信交互：己方发送失败';
	state_list[1323] = '私信交互：对方私信读取失败';
	state_list[1324] = '读取私信内容字段失败';
	state_list[1325] = '获取未读私信数目失败';
	state_list[1326] = '获取私信总数目失败';
	state_list[1327] = '联系人不存在';
	state_list[1328] = '添加联系人失败';
	state_list[1329] = '更新最近联系人联系时间失败';
	state_list[1330] = '获取联系人失败';
	
	
	
	state_list[1350] = '用户未设置过标签';
	state_list[1399] = '机构未设置过标签';
	...
	state_list[1407] = '没查到区';
	state_list[1408] = '请填写角色';
