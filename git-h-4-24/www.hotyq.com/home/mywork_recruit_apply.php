...
//                     }
                    ...
                    if($apply_list){
                                ...
                                if (empty($apply_info_list) || !isset($apply_info_list)) {
                                        ...
                                        if($data['total_rows'] > 0){
                                          ...
                                          //分页
                                          $apply_num = count($apply_info_list);#招募总数
                                          $pagesize = 10;
                                          ...
                                          $show_apply_list = array_slice($apply_info_list, $from_rows, $pagesize);
            ...
            $smarty -> display("home/mywork_recruit_apply.html");